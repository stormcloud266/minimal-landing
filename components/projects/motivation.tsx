    ...
    <Section top={false} bottom={false}>
      <Wrapper>
        <div className="flex flex-col lg:flex-row justify-center mx-auto max-w-2xl lg:max-w-none">
          <div className="basis-1/4 lg:text-right pt-12 lg:pt-20 pl-10 lg:pl-0 lg:pr-32 border-l border-gray-500 lg:border-none">
            <Fade x={-10}>
        ...
        <div className="flex flex-col lg:flex-row justify-center mx-auto max-w-2xl lg:max-w-none">
          <div className="basis-1/4 lg:text-right pt-10 lg:pt-20 pl-10 lg:pl-0 lg:pr-32 border-l border-gray-500 lg:border-none">
            <Fade x={-10}>
          ...
          <div className="basis-3/4 pl-10 md:pl-12 lg:pl-32 pb-12 pt-6 lg:py-20 border-l border-gray-500 max-w-4xl">
            <Fade>
              <h2 className="text-4xl mb-6 font-light leading-normal">
                {solutionHeader}
              </h2>
